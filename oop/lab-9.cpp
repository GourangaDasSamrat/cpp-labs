...
public:
  ...
  void brew() override { cout << "Cold Coffee brewed." << endl; }
  void serve() override { cout << "Cold Coffee served.\n" << endl; }
};
...
public:
  ...
  void brew() override { cout << "Mocha brewed." << endl; }
  void serve() override { cout << "Mocha served.\n" << endl; }
};
